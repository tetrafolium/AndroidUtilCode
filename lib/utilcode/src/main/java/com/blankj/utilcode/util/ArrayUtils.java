...
public class ArrayUtils {
  ...
  public static long[] newLongArray(long... array) { return array; }

  public static int[] newIntArray(int... array) { return array; }

  public static short[] newShortArray(short... array) { return array; }

  public static char[] newCharArray(char... array) { return array; }

  public static byte[] newByteArray(byte... array) { return array; }

  public static double[] newDoubleArray(double... array) { return array; }

  public static float[] newFloatArray(float... array) { return array; }

  public static boolean[] newBooleanArray(boolean... array) { return array; }
   ...
   */
  public static boolean isEmpty(Object array) { return getLength(array) == 0; }
  ...
  public static double[] subArray(double[] array, int startIndexInclusive,
                                  int endIndexExclusive) {
    return (double[])realSubArray(array, startIndexInclusive,
                                  endIndexExclusive);
  }
  ...
  public static boolean[] subArray(boolean[] array, int startIndexInclusive,
                                   int endIndexExclusive) {
    return (boolean[])realSubArray(array, startIndexInclusive,
                                   endIndexExclusive);
  }

  private static Object realSubArray(Object array, int startIndexInclusive,
                                     int endIndexExclusive) {
    if (array == null) {
      return null;
    }
  ...
  /**
   * <p>Copies the given array and adds the given element at the end of the new
   * array.</p>
   *
   ...
   *
   * <p>If the input array is <code>null</code>, a new one element array is
   * returned whose component type is the same as the element.</p>
   *
   * <pre>
  ...
  private static Object realAddOne(Object array, Object element,
   ...
   * returned, it is always a new array.</p>
   *
   * <pre>
   ...
   * ArrayUtils.add(["a", "b", "c"], ["1", "2", "3"]) = ["a", "b", "c", "1",
   * "2", "3"]
   * </pre>
   *
  ...
  private static Object realAddArr(Object array1, Object array2) {
    ...
    Object joinedArray =
        Array.newInstance(array1.getClass().getComponentType(), len1 + len2);
  ...
  private static Object realAddArr(Object array1, int index, Object array2,
                                   Class clss) {
    if (array1 == null && array2 == null)
      return null;
    int len1 = getLength(array1);
  ...
  private static Object realAdd(Object array, int index, Object element,
                                Class clss) {
    if (array == null) {
      if (index != 0) {
  ...
  public static int indexOf(Object[] array, final Object objectToFind,
                            int startIndex) {
    if (array == null) {
