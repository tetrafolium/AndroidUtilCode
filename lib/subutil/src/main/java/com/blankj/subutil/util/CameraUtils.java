...
public final class CameraUtils {
  ...
  //     */
  //    public static Intent getImagePickerIntent(int outputX, int outputY, Uri
  //    fromFileURI,
  //                                              Uri saveFileURI) {
  //        return getImagePickerIntent(1, 1, outputX, outputY, true,
  //        fromFileURI, saveFileURI);
  //    }
  //
  //    /**
  //     * 获取[跳转至相册选择界面,并跳转至裁剪界面，默认可缩放裁剪区域]的Intent
  //     */
  //    public static Intent getImagePickerIntent(int aspectX, int aspectY, int
  //    outputX, int outputY, Uri fromFileURI,
  //                                              Uri saveFileURI) {
  //        return getImagePickerIntent(aspectX, aspectY, outputX, outputY,
  //        true, fromFileURI, saveFileURI);
  //    }
  //
  //    /**
  ...
  //     */
  //    public static Intent getImagePickerIntent(int aspectX, int aspectY, int
  //    outputX, int outputY, boolean canScale,
  //                                              Uri fromFileURI, Uri
  //                                              saveFileURI) {
  ...
  //     */
  //    public static Intent getCropImageIntent(int outputX, int outputY, Uri
  //    fromFileURI,
  //                                            Uri saveFileURI) {
  //        return getCropImageIntent(1, 1, outputX, outputY, true, fromFileURI,
  //        saveFileURI);
  //    }
  //
  //    /**
  //     * 获取[跳转至裁剪界面,默认可缩放]的Intent
  //     */
  //    public static Intent getCropImageIntent(int aspectX, int aspectY, int
  //    outputX, int outputY, Uri fromFileURI,
  //                                            Uri saveFileURI) {
  //        return getCropImageIntent(aspectX, aspectY, outputX, outputY, true,
  //        fromFileURI, saveFileURI);
  //    }
  //
  //
  ...
  //     * @return bitmap
  //     */
  //    public static Bitmap getChoosedImage(final Activity context, final
  //    Intent data) {
  ...
  //     * @return
  //     */
  //    public static String getChoosedImagePath(final Activity context, final
  //    Intent data) {
  //        if (data == null) return null;
  //        String path = "";
  ...
  //        Cursor cursor = resolver.query(originalUri, projection, null, null,
  //        null); if (null != cursor) {
  //            try {
  //                int column_index =
  ...
  //     * @return 文件
  //     */
  //    public static File getTakePictureFile(final Intent data, final String
  //    filePath) {
  //        if (data == null) return null;
  ...
  //        if (ImageUtils.save(photo, file, Bitmap.CompressFormat.JPEG)) return
  //        file; return null;
  //    }
}
