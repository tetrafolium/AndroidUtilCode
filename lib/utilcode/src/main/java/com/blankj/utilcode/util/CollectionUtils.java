...
public final class CollectionUtils {
  ...
  /**
   * Returns a new read-only list only of those given elements, that are not
   * null.
   *
   * @param array The array.
   * @return a new read-only list only of those given elements, that are not
   *     null
   */
  @SafeVarargs
  ...
  @SafeVarargs
  public static <E> TreeSet<E> newTreeSetNotNull(Comparator<E> comparator,
                                                 E... array) {
    TreeSet<E> set = new TreeSet<>(comparator);
    if (array == null || array.length == 0)
      return set;
  ...
  public static Collection intersection(final Collection a,
    ...
    elts.addAll(b);
    for (Object obj : elts) {
      for (int i = 0, m = Math.min(getFreq(obj, mapA), getFreq(obj, mapB));
           i < m; i++) {
        list.add(obj);
      }
    }
   ...
   * #intersection intersection(a,b)})</tt> or <tt>{@link #union union}({@link
   * #subtract subtract(a,b)},{@link #subtract subtract(b,a)})</tt>.
   *
   * @param a the first collection
   * @param b the second collection
   ...
   * @see #intersection
   */
  public static boolean containsAny(final Collection coll1,
   ...
   * cardinality of <i>f</i> in <i>a</i>. <p> The implementation assumes <ul>
   ...
   * @see Collection#containsAll
   */
  public static boolean isProperSubCollection(final Collection a,
                                              final Collection b) {
    if (a == null || b == null)
      return false;
   ...
   * predicate. <p> If the input collection or predicate is null, or no element
   * of the collection matches the predicate, null is returned.
   *
   ...
   * predicate into an output collection. <p> If the input predicate is
   * <code>null</code>, the result is an empty list.
   *
   * @param inputCollection the collection to get the input from, may not be
   *     null
   * @param predicate       the predicate to use, may be null
   ...
   */
  public static <E1, E2> void transform(Collection<E1> collection,
                                        Transformer<E1, E2> transformer) {
   ...
   * transformed by the given transformer. <p> If the input transformer is null,
   ...
   */
  public static <E1, E2> Collection<E2>
  collect(final Collection<E1> inputCollection,
   ...
   * predicate. <p> A <code>null</code> collection or predicate matches no
   * elements.
   *
   * @param collection the collection to get the input from, may be null
   * @param predicate  the predicate to use, may be null
   ...
   */
  public static <E> int countMatches(Collection<E> collection,
                                     Predicate<E> predicate) {
    if (collection == null || predicate == null)
      return 0;
    int count = 0;
   ...
   * collection. <p> A <code>null</code> collection or predicate returns false.
   *
   * @param collection the collection to get the input from, may be null
   * @param predicate  the predicate to use, may be null
   ...
   * <code>IndexOutOfBoundsException</code> is thrown.</li> <li> Collection --
   * the value returned is the <code>index</code>-th object returned by the
   * collection's default iterator, if there is such an element.</li> <li>
   * Iterator or Enumeration -- the value returned is the <code>index</code>-th
   * object in the Iterator/Enumeration, if there is such an element.  The
   * Iterator/Enumeration is advanced to <code>index</code> (or to the end, if
   ...
   * method is useful if you do not wish to modify the collection <code>c</code>
   * and thus cannot call <code>c.retainAll(retain);</code>.
   *
   ...
   */
  public static <E> Collection<E> retainAll(Collection<E> collection,
                                            Collection<E> retain) {
   ...
   * <code>remove</code> contains <code>e</code>, in which case the cardinality
   * is zero. This method is useful if you do not wish to modify the collection
   ...
   *                                       its list-iterator does not support
   * the <tt>set</tt> operation.
   */
  public static <T> void shuffle(List<T> list) { Collections.shuffle(list); }
  ...
  public interface Closure<E> { void execute(int index, E item); }

  public interface Transformer<E1, E2> { E2 transform(E1 input); }

  public interface Predicate<E> { boolean evaluate(E item); }
}
