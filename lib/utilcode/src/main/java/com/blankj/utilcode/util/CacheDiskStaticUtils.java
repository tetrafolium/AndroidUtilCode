...
public final class CacheDiskStaticUtils {
   ...
   */
  public static void
  setDefaultCacheDiskUtils(final CacheDiskUtils cacheDiskUtils) {
   ...
   * @return {@code true}: success<br>{@code false}: fail
   */
  public static boolean clear() { return clear(getDefaultCacheDiskUtils()); }
  ...
  public static <T> T getParcelable(
      ...
      final T defaultValue, @NonNull final CacheDiskUtils cacheDiskUtils) {
   ...
   */
  public static long
  getCacheSize(@NonNull final CacheDiskUtils cacheDiskUtils) {
   ...
   */
  public static int
  getCacheCount(@NonNull final CacheDiskUtils cacheDiskUtils) {
