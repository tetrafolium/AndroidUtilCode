...
public Request addHeader(@NonNull final String name,
...
public static Body create(@NonNull String mediaType,
...
public static Body form(@NonNull final Map<String, String> form,
                        String charset) {
	String mediaType =
		"application/x-www-form-urlencoded;charset=" + checkCharset(charset);
