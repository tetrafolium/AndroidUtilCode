...
public final class SSLConfig {
  ...
  public SSLConfig(@NonNull SSLSocketFactory factory,
                   @NonNull HostnameVerifier verifier) {
    mSSLSocketFactory = factory;
    mHostnameVerifier = verifier;
  }

  public static final HostnameVerifier DEFAULT_VERIFIER =
  ...
  public static final SSLConfig DEFAULT_SSL_CONFIG =
      new SSLConfig(DEFAULT_SSL_SOCKET_FACTORY, DEFAULT_VERIFIER);
