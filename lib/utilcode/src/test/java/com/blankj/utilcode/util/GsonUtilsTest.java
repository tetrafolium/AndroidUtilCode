...
public void fromJson() {
	...
	Assert.assertEquals(
		GsonUtils.toJson(result),
		GsonUtils.toJson(GsonUtils.fromJson(
					 GsonUtils.toJson(result),
					 GsonUtils.getType(Result.class,
					                   GsonUtils.getListType(Person.class)))));
}
...
public void getType() {
	...
	Assert.assertEquals(
		...
		GsonUtils.getMapType(String.class, GsonUtils.getListType(String.class))
		.toString());
}
