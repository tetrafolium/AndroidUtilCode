...
public class CollectionUtilsTest extends BaseTest {
  ...
  public void getCardinalityMap() {
    ...
    ArrayList<String> l0 =
        CollectionUtils.newArrayList("0", "0", "1", "1", "2");
  ...
  public void find() {
    ...
    Assert.assertNull(
        CollectionUtils.find(null, new CollectionUtils.Predicate<String>() {
          @Override
          public boolean evaluate(String item) {
            return true;
          }
        }));
    Assert.assertEquals("1", CollectionUtils.find(
                                 list, new CollectionUtils.Predicate<String>() {
                                   @Override
                                   public boolean evaluate(String item) {
  ...
  public void filter() {
    ...
    Assert.assertTrue(CollectionUtils.isEqualCollection(
        CollectionUtils.newArrayList(2, 3), l1));
  }
  ...
  public void select() {
    ...
    Assert.assertEquals(0, CollectionUtils
                               .select(null,
                                       new CollectionUtils.Predicate<Object>() {
                                         @Override
  ...
  public void selectRejected() {
    ...
    Assert.assertTrue(CollectionUtils.isEqualCollection(
        ...
        CollectionUtils.selectRejected(
            list, new CollectionUtils.Predicate<Integer>() {
              @Override
              public boolean evaluate(Integer item) {
                return item > 1;
              }
    ...
    Collection<Integer> list1 = CollectionUtils.selectRejected(
        list, new CollectionUtils.Predicate<Integer>() {
          @Override
          public boolean evaluate(Integer item) {
            return false;
  ...
  public void transform() {
    ...
    CollectionUtils.transform(
        l0, new CollectionUtils.Transformer<Integer, Object>() {
          @Override
    ...
    CollectionUtils.transform(
        l1, new CollectionUtils.Transformer<Integer, String>() {
          @Override
    ...
    Assert.assertTrue(CollectionUtils.isEqualCollection(
        CollectionUtils.newArrayList("0", "1", "2", "3"), l1));
  }
  ...
  public void collect() {
    ...
    Assert.assertTrue(
        CollectionUtils.isEmpty(CollectionUtils.collect(null, null)));
    Assert.assertTrue(
        CollectionUtils.isEmpty(CollectionUtils.collect(list, null)));
    Assert.assertTrue(CollectionUtils.isEmpty(
        CollectionUtils.collect(null, new CollectionUtils.Transformer() {
          @Override
    ...
    Assert.assertTrue(CollectionUtils.isEqualCollection(
        ...
        CollectionUtils.collect(
            list, new CollectionUtils.Transformer<Integer, String>() {
              @Override
              public String transform(Integer input) {
                return String.valueOf(input);
              }
  ...
  public void countMatches() {
    ...
    Assert.assertEquals(0, CollectionUtils.countMatches(
                               null, new CollectionUtils.Predicate<Object>() {
                                 @Override
                                 public boolean evaluate(Object item) {
                                   return false;
                                 }
                               }));
    Assert.assertEquals(2, CollectionUtils.countMatches(
                               list, new CollectionUtils.Predicate<Integer>() {
                                 @Override
                                 public boolean evaluate(Integer item) {
                                   return item > 1;
  ...
  public void exists() {
    ...
    Assert.assertFalse(
        CollectionUtils.exists(null, new CollectionUtils.Predicate<Object>() {
          @Override
          public boolean evaluate(Object item) {
            return false;
          }
    ...
    Assert.assertTrue(
        CollectionUtils.exists(list, new CollectionUtils.Predicate<Integer>() {
          @Override
          public boolean evaluate(Integer item) {
            return item > 1;
          }
  ...
  public void addAll() {
    ...
    Assert.assertTrue(CollectionUtils.isEqualCollection(
        CollectionUtils.newArrayList(0, 1, 2, 3, 4, 5), l1));
  }
  ...
  public void retainAll() {
    ...
    Assert.assertTrue(CollectionUtils.isEqualCollection(
        CollectionUtils.newArrayList(0, 1),
        CollectionUtils.retainAll(list,
                                  CollectionUtils.newArrayList(0, 1, 6))));
  }
  ...
  public void removeAll() {
    ...
    Assert.assertTrue(CollectionUtils.isEqualCollection(
        CollectionUtils.newArrayList(2, 3),
        CollectionUtils.removeAll(list,
                                  CollectionUtils.newArrayList(0, 1, 6))));
  }
}
