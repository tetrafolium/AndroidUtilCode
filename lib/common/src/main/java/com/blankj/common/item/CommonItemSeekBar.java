...
public CommonItemSeekBar(
	@StringRes int title, int maxProgress, int curProgress,
	@NonNull SeekBar.OnSeekBarChangeListener itemClickListener) {
	this(StringUtils.getString(title), maxProgress, curProgress,
	     itemClickListener);
}

public CommonItemSeekBar(
	@NonNull CharSequence title, int maxProgress, int curProgress,
	@NonNull SeekBar.OnSeekBarChangeListener itemClickListener) {
