...
//
//
//    public static void setCircleImage(Context context, String url, ImageView
//    view) {
...
//        RequestOptions().placeholder(R.drawable.def_img)
//                .error(R.drawable.def_img).diskCacheStrategy(DiskCacheStrategy.AUTOMATIC).dontAnimate();
//        Glide.with(context).load(url).apply(requestOptions).into(view);
//    }
//
//    private static void setSvgImage(Context context, String url, ImageView
//    view) {
