...
public final class ToastUtils {
   ...
   */
  public static void setGravity(final int gravity, final int xOffset,
                                final int yOffset) {
    sGravity = gravity;
    sXOffset = xOffset;
    sYOffset = yOffset;
  ...
  private static void show(final String format, final int duration,
                           final Object... args) {
    String text = format;
    if (text == null) {
      text = NULL;
  ...
  private static View getView(@LayoutRes final int layoutId) {
    LayoutInflater inflate = (LayoutInflater)Utils.getApp().getSystemService(
  ...
  static class ToastFactory {
    ...
    private static Toast makeNormalToast(Context context, CharSequence text,
                                         int duration) {
      @SuppressLint("ShowToast")
  ...
  static class SystemToast extends AbsToast {
    ...
    SystemToast(Toast toast) {
      ...
      if (Build.VERSION.SDK_INT == Build.VERSION_CODES.N_MR1) {
        try {
          ...
          Field mTNmHandlerField =
              mTNField.getType().getDeclaredField("mHandler");
    ...
    static class SafeHandler extends Handler {
      ...
      SafeHandler(Handler impl) { this.impl = impl; }
  ...
  static class ToastWithoutNotification extends AbsToast {
    ...
    ToastWithoutNotification(Toast toast) { super(toast); }
    ...
    private void realShow() {
      ...
      if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
        ...
        UtilsBridge.addActivityLifecycleCallbacks(
            topActivity, getActivityLifecycleCallbacks());
      }
    ...
    private void setToastParams() {
      ...
      if ((mParams.gravity & Gravity.HORIZONTAL_GRAVITY_MASK) ==
          Gravity.FILL_HORIZONTAL) {
        mParams.horizontalWeight = 1.0f;
      }
      if ((mParams.gravity & Gravity.VERTICAL_GRAVITY_MASK) ==
  ...
  static abstract class AbsToast implements IToast {
    ...
    AbsToast(Toast toast) { mToast = toast; }
