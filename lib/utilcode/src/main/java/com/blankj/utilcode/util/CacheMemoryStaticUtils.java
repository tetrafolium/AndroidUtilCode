...
public final class CacheMemoryStaticUtils {
   ...
   */
  public static void
  setDefaultCacheMemoryUtils(final CacheMemoryUtils cacheMemoryUtils) {
   ...
   */
  public static void clear() { clear(getDefaultCacheMemoryUtils()); }
   ...
   */
  public static int
  getCacheCount(@NonNull final CacheMemoryUtils cacheMemoryUtils) {
  ...
  remove(@NonNull final String key,
         @NonNull final CacheMemoryUtils cacheMemoryUtils) {
