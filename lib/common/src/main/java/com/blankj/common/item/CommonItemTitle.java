...
public class CommonItemTitle extends CommonItem {
  ...
  public CommonItemTitle(@NonNull Utils.Supplier<CharSequence> getTitleSupplier,
  ...
  public void setTitle(CharSequence title) { setTitle(title, true); }

  public void setContent(CharSequence content) { setContent(content, true); }
