...
public final class IntentUtils {
  ...
  getLaunchAppDetailsSettingsIntent(final String pkgName,
   ...
   */
  public static Intent
  getShareImageIntent(final String content,
  ...
  public static Intent getShutdownIntent() {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      ...
      intent =
          new Intent("com.android.internal.intent.action.REQUEST_SHUTDOWN");
    }
   ...
   * android:name="android.permission.CALL_PHONE" />}</p>
   *
   * @param phoneNumber The phone number.
   * @return the intent of call
   */
  ...
  private static Intent getIntent(final Intent intent,
                                  final boolean isNewTask) {
  ...
  //
  //
  //    public static Intent buildImageGetIntent(final Uri saveTo, final int
  //    outputX, final int outputY, final boolean returnData) {
  //        return buildImageGetIntent(saveTo, 1, 1, outputX, outputY,
  //        returnData);
  //    }
  //
  //    public static Intent buildImageGetIntent(Uri saveTo, int aspectX, int
  //    aspectY,
  ...
  //        Bitmap.CompressFormat.PNG.toString()); return intent;
  //    }
  //
  //    public static Intent buildImageCropIntent(final Uri uriFrom, final Uri
  //    uriTo, final int outputX, final int outputY, final boolean returnData) {
  //        return buildImageCropIntent(uriFrom, uriTo, 1, 1, outputX, outputY,
  //        returnData);
  //    }
  //
  //    public static Intent buildImageCropIntent(Uri uriFrom, Uri uriTo, int
  //    aspectX, int aspectY,
  //                                              int outputX, int outputY,
  //                                              boolean returnData) {
