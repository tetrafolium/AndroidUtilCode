...
public final class Utils {
  ...
  @SuppressLint("StaticFieldLeak") private static Application sApp;
  ...
  public static Application getApp() {
    ...
    Log.i("Utils",
          UtilsBridge.getCurrentProcessName() + " reflect app success.");
    return sApp;
  }
  ...
  public abstract static class Task<Result>
      extends ThreadUtils.SimpleTask<Result> {

    private Consumer<Result> mConsumer;

    public Task(final Consumer<Result> consumer) { mConsumer = consumer; }
  ...
  public interface Func1<Ret, Par> { Ret call(Par param); }
}
