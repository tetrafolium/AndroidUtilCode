...
public class TestHierarchicalMethodsBase {
  ...
  public String pub_base_method(int number) { return PUBLIC_RESULT; }

  public String pub_method(int number) { return PUBLIC_RESULT; }

  private String priv_method(int number) { return PRIVATE_RESULT; }

  private String very_priv_method() { return PRIVATE_RESULT; }
}
