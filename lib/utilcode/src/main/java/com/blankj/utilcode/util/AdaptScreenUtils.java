...
public final class AdaptScreenUtils {
  ...
  /**
   * Adapt for the horizontal screen, and call it in {@link
   * android.app.Activity#getResources()}.
   */
  public static Resources adaptWidth(final Resources resources,
  ...
  /**
   * Adapt for the vertical screen, and call it in {@link
   * android.app.Activity#getResources()}.
   */
  public static Resources adaptHeight(final Resources resources,
  ...
  private static void applyDisplayMetrics(final Resources resources,
                                          final float newXdpi) {
  ...
  private static void preLoad() {
    applyDisplayMetrics(Resources.getSystem(),
  ...
  private static void applyMetricsFields(final Resources resources,
                                         final float newXdpi) {
