...
public class TouchUtils {
  ...
  public static void setOnTouchListener(final View v,
                                        final OnTouchUtilsListener listener) {
  ...
  public static abstract class OnTouchUtilsListener
    ...
    public OnTouchUtilsListener() { resetTouch(-1, -1); }
    ...
    public abstract boolean onMove(View view, @Direction int direction, int x,
                                   int y, int dx, int dy, int totalX,
                                   int totalY, MotionEvent event);

    public abstract boolean onStop(View view, @Direction int direction, int x,
                                   int y, int totalX, int totalY, int vx,
                                   int vy, MotionEvent event);
    ...
    public boolean onUtilsMove(View view, MotionEvent event) {
      ...
      boolean consumeMove = onMove(view, direction, x, y, x - lastX, y - lastY,
                                   x - downX, y - downY, event);
      lastX = x;
      lastY = y;
      return consumeMove;
    }
