...
public final class EncryptUtils {
   ...
   * @return the hex string of HmacMD5 encryption
   */
  public static String encryptHmacMD5ToString(final String data,
                                              final String key) {
   ...
   * @return the hex string of HmacMD5 encryption
   */
  public static String encryptHmacMD5ToString(final byte[] data,
                                              final byte[] key) {
   ...
   * @return the hex string of HmacSHA1 encryption
   */
  public static String encryptHmacSHA1ToString(final String data,
                                               final String key) {
    if (data == null || data.length() == 0 || key == null || key.length() == 0)
      return "";
   ...
   * @return the hex string of HmacSHA1 encryption
   */
  public static String encryptHmacSHA1ToString(final byte[] data,
                                               final byte[] key) {
   ...
   * @return the hex string of HmacSHA224 encryption
   */
  public static String encryptHmacSHA224ToString(final String data,
                                                 final String key) {
    if (data == null || data.length() == 0 || key == null || key.length() == 0)
      return "";
   ...
   * @return the hex string of HmacSHA224 encryption
   */
  public static String encryptHmacSHA224ToString(final byte[] data,
                                                 final byte[] key) {
   ...
   * @return the hex string of HmacSHA256 encryption
   */
  public static String encryptHmacSHA256ToString(final String data,
                                                 final String key) {
    if (data == null || data.length() == 0 || key == null || key.length() == 0)
      return "";
   ...
   * @return the hex string of HmacSHA256 encryption
   */
  public static String encryptHmacSHA256ToString(final byte[] data,
                                                 final byte[] key) {
   ...
   * @return the hex string of HmacSHA384 encryption
   */
  public static String encryptHmacSHA384ToString(final String data,
                                                 final String key) {
    if (data == null || data.length() == 0 || key == null || key.length() == 0)
      return "";
   ...
   * @return the hex string of HmacSHA384 encryption
   */
  public static String encryptHmacSHA384ToString(final byte[] data,
                                                 final byte[] key) {
   ...
   * @return the hex string of HmacSHA512 encryption
   */
  public static String encryptHmacSHA512ToString(final String data,
                                                 final String key) {
    if (data == null || data.length() == 0 || key == null || key.length() == 0)
      return "";
   ...
   * @return the hex string of HmacSHA512 encryption
   */
  public static String encryptHmacSHA512ToString(final byte[] data,
                                                 final byte[] key) {
   ...
   *                       buffer are copied to protect against subsequent
   * modification.
   * @return the Base64-encode bytes of DES encryption
   */
  ...
  public static String encryptDES2HexString(final byte[] data, final byte[] key,
    ...
    return UtilsBridge.bytes2HexString(
        encryptDES(data, key, transformation, iv));
  }
  ...
  public static byte[] decryptHexStringDES(final String data, final byte[] key,
                                           final String transformation,
                                           final byte[] iv) {
    return decryptDES(UtilsBridge.hexString2Bytes(data), key, transformation,
                      iv);
  }
  ...
  public static byte[] decryptHexString3DES(final String data, final byte[] key,
                                            final String transformation,
                                            final byte[] iv) {
    return decrypt3DES(UtilsBridge.hexString2Bytes(data), key, transformation,
                       iv);
  }
  ...
  public static String encryptAES2HexString(final byte[] data, final byte[] key,
                                            ...
                                            final byte[] iv) {
    return UtilsBridge.bytes2HexString(
        encryptAES(data, key, transformation, iv));
  }
  ...
  public static byte[] decryptHexStringAES(final String data, final byte[] key,
                                           final String transformation,
                                           final byte[] iv) {
    return decryptAES(UtilsBridge.hexString2Bytes(data), key, transformation,
                      iv);
  }
   ...
   * @return the bytes of symmetric encryption or decryption
   */
  private static byte[] symmetricTemplate(final byte[] data, final byte[] key,
                                          final String algorithm,
                                          final String transformation,
                                          final byte[] iv,
  ...
  public static byte[] encryptRSA2Base64(final byte[] data,
                                         ...
                                         final int keySize,
                                         final String transformation) {
    return UtilsBridge.base64Encode(
        encryptRSA(data, publicKey, keySize, transformation));
  }
  ...
  public static byte[] decryptBase64RSA(final byte[] data,
                                        ...
                                        final int keySize,
                                        final String transformation) {
    return decryptRSA(UtilsBridge.base64Decode(data), privateKey, keySize,
                      transformation);
  }
  ...
  public static byte[] decryptHexStringRSA(final String data,
                                           ...
                                           final int keySize,
                                           final String transformation) {
    return decryptRSA(UtilsBridge.hexString2Bytes(data), privateKey, keySize,
                      transformation);
  }
