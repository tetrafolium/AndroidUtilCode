...
public final class PermissionUtils {
  ...
  private static void startWriteSettingsActivity(final Activity activity,
  ...
  public static void launchAppDetailsSettings() {
    Intent intent = UtilsBridge.getLaunchAppDetailsSettingsIntent(
        Utils.getApp().getPackageName(), true);
    if (!UtilsBridge.isIntentAvailable(intent))
      return;
   ...
   */
  public static PermissionUtils
  permission(@Permission final String... permissions) {
  ...
  private void rationalInner(final UtilsTransActivity activity,
                             final Runnable againRunnable) {
  ...
  private void requestCallback() {
    if (mSingleCallback != null) {
      mSingleCallback.callback(mPermissionsDenied.isEmpty(),
                               mPermissionsGranted, mPermissionsDeniedForever,
                               mPermissionsDenied);
    ...
    if (mFullCallback != null) {
      if (mPermissionsRequest.size() == 0 || mPermissionsGranted.size() > 0) {
  ...
  static final class PermissionActivityImpl
    ...
    @Override
    public void onCreated(final UtilsTransActivity activity,
    ...
    private void requestPermissions(Activity activity) {
      if (sInstance.mPermissionsRequest != null) {
        ...
        activity.requestPermissions(
            sInstance.mPermissionsRequest.toArray(new String[size]), 1);
      }
    }

    @Override
    public void
    onRequestPermissionsResult(UtilsTransActivity activity, int requestCode,
    ...
    @Override
    public boolean dispatchTouchEvent(UtilsTransActivity activity,
                                      MotionEvent ev) {
      activity.finish();
      return true;
    }
    ...
    @Override
    public void onActivityResult(UtilsTransActivity activity, int requestCode,
  ...
  public interface FullCallback {
    ...
    void onDenied(@NonNull List<String> deniedForever,
                  @NonNull List<String> denied);
  }

  public interface ThemeCallback { void onActivityCreate(Activity activity); }
}
