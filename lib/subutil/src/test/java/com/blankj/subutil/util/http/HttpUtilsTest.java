...
//        HttpUtils.call(Request.withUrl(BASE_URL + "/listUsers"), new
//        ResponseCallback() {
//            @Override
...
//                System.out.println(response.getHeaders());
//                List<UserBean> users =
//                response.getJson(GsonUtils.getListType(UserBean.class));
...
//            public void onResponse(Response response) {
//                System.out.println(response.getHeaders());
//                File file = new File(TestConfig.PATH_HTTP +
//                TimeUtils.getNowMills()); response.downloadFile(file);
