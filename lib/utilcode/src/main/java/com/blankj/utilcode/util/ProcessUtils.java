...
public final class ProcessUtils {
  ...
  public static String getForegroundProcessName() {
    ...
    List<ActivityManager.RunningAppProcessInfo> pInfo =
    ...
    if (android.os.Build.VERSION.SDK_INT >
      ...
      try { // Access to usage information.
        ...
        AppOpsManager aom = (AppOpsManager)Utils.getApp().getSystemService(
        ...
        UsageStatsManager usageStatsManager =
            (UsageStatsManager)Utils.getApp().getSystemService(
  ...
  killBackgroundProcesses(@NonNull final String packageName) {
    ActivityManager am = (ActivityManager)Utils.getApp().getSystemService(
        Context.ACTIVITY_SERVICE);
    List<ActivityManager.RunningAppProcessInfo> info =
        am.getRunningAppProcesses();
  ...
  private static String getCurrentProcessNameByReflect() {
    ...
    try {
      ...
      Field activityThreadField =
          loadedApk.getClass().getDeclaredField("mActivityThread");
