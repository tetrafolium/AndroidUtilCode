...
public class FloatToast extends BaseFloatView {
  ...
  private void setType(int type) { mType = type; }

  private void setMsg(String msg) { mMsg = msg == null ? "" : msg; }

  public static void showShort(String msg) { show(msg, 2000); }

  public static void showShort(@Type int type, String msg) {
    show(type, msg, 2000);
  }

  public static void showLong(String msg) { show(msg, 3500); }
