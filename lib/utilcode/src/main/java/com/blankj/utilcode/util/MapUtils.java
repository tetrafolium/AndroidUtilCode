...
newLinkedHashMap(final Pair<K, V>... pairs) {
...
transform(Map<K1, V1> map, final Transformer<K1, V1, K2, V2> transformer) {
...
public interface Closure<K, V> { void execute(K key, V value); }
