 ...
 * </pre>
 */
public abstract class BaseContentView<T extends BaseContentFloatView<T>>
    extends FrameLayout implements OnBackListener {
  ...
  public T getFloatView() { return mFloatView; }

  public boolean isAddStack() { return isAddStack; }

  public void setOnRefreshListener(RecyclerView rv,
  ...
  OnRefreshListener getOnRefreshListener() { return mRefreshRunnable; }

  boolean isRefreshEnabled() { return mRefreshEnabled; }
  ...
  private void attachRefresh(RecyclerView rv) {
    rv.addOnScrollListener(new RecyclerView.OnScrollListener() {
      ...
      public void onScrollStateChanged(@NonNull RecyclerView recyclerView,
        ...
        mRefreshEnabled = newState == RecyclerView.SCROLL_STATE_IDLE &&
