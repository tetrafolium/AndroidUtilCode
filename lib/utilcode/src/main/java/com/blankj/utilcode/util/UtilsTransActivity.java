...
public class UtilsTransActivity extends AppCompatActivity {
  ...
  private static final Map<UtilsTransActivity, TransActivityDelegate>
  ...
  public void onRequestPermissionsResult(int requestCode, String[] permissions,
    ...
    if (callback == null)
      return;
    callback.onRequestPermissionsResult(this, requestCode, permissions,
                                        grantResults);
  }
  ...
  public abstract static class TransActivityDelegate implements Serializable {
    public void onCreateBefore(@NonNull UtilsTransActivity activity,
                               @Nullable Bundle savedInstanceState) { /**/
    }

    public void onCreated(@NonNull UtilsTransActivity activity,
                          @Nullable Bundle savedInstanceState) { /**/
    }
    ...
    public void onSaveInstanceState(@NonNull UtilsTransActivity activity,
                                    Bundle outState) { /**/
    }
    ...
    public void onActivityResult(@NonNull UtilsTransActivity activity,
                                 int requestCode, int resultCode,
                                 Intent data) { /**/
    }

    public boolean dispatchTouchEvent(@NonNull UtilsTransActivity activity,
                                      MotionEvent ev) {
      return false;
    }
  }
