 ...
 * </pre>
 */
public class BaseItemAdapter<Item extends BaseItem>
    extends RecyclerView.Adapter<ItemViewHolder> {

  public List<Item> mItems;
  private RecyclerView mRecyclerView;

  public BaseItemAdapter() { this(false); }
  ...
  @Override
  public final void onBindViewHolder(@NonNull ItemViewHolder holder,
                                     int position) {
  ...
  public void setItems(@NonNull final List<Item> items) { mItems = items; }

  public List<Item> getItems() { return Collections.unmodifiableList(mItems); }
  ...
  public int removeItemById(final long id) { return removeItemById(id, false); }
  ...
  public void addItem(@NonNull final Item item) { addItem(item, false); }
  ...
  public void addItem(@IntRange(from = 0) final int index,
                      @NonNull final Item item) {
    addItem(index, item, false);
  }

  public void addItem(@IntRange(from = 0) final int index,
                      @NonNull final Item item, boolean notifyInserted) {
  ...
  public void addItems(@IntRange(from = 0) final int index,
  ...
  public void swapItem(@IntRange(from = 0) final int firstIndex,
                       @IntRange(from = 0) final int secondIndex) {
  ...
  public Item replaceItem(@IntRange(from = 0) final int index,
                          @NonNull final Item item) {
    return replaceItem(index, item, false);
  }

  public Item replaceItem(@IntRange(from = 0) final int index,
                          @NonNull final Item item, boolean notifyChanged) {
