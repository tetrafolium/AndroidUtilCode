...
public final class SPUtils {
   ...
   */
  public int getInt(@NonNull final String key) { return getInt(key, -1); }
   ...
   */
  public long getLong(@NonNull final String key) { return getLong(key, -1L); }
   ...
   * @param key          The key of sp.
   * @param defaultValue The default value if the sp doesn't exist.
   * @return the set of string value if sp exists or {@code defaultValue}
   *     otherwise
   */
  public Set<String> getStringSet(@NonNull final String key,
   ...
   * @param key The key of sp.
   */
  public void remove(@NonNull final String key) { remove(key, false); }
