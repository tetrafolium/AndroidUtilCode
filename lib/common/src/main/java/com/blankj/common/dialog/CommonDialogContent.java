...
public class CommonDialogContent extends BaseDialogFragment {
  ...
  public CommonDialogContent
  init(Context context, final CharSequence title, final CharSequence content,
    ...
    super.init(context, new DialogLayoutCallback() {
      ...
      public void initView(final BaseDialogFragment dialog, View contentView) {
        ...
        cdcBottomPositiveTv =
            contentView.findViewById(R.id.cdcBottomPositiveTv);
        cdcBottomNegativeTv =
            contentView.findViewById(R.id.cdcBottomNegativeTv);
