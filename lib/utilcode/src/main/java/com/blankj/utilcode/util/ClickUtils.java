...
public class ClickUtils {
   ...
   */
  public static void applyPressedViewScale(final View view,
  ...
  private static Drawable createStyleDrawable(Drawable src, int style,
                                              float value) {
    if (src == null) {
  ...
  private static Drawable createAlphaDrawable(Drawable drawable, float alpha) {
    ...
    DrawableWrapperBefore21 drawableWrapper =
        new DrawableWrapperBefore21(drawable);
  ...
  private static ColorMatrixColorFilter getDarkColorFilter(float darkAlpha) {
    return new ColorMatrixColorFilter(new ColorMatrix(
        new float[] {darkAlpha, 0, 0,         0, 0, 0, darkAlpha, 0, 0, 0,
                     0,         0, darkAlpha, 0, 0, 0, 0,         0, 2, 0}));
  }
   ...
   */
  public static void
  applySingleDebouncing(final View view, final View.OnClickListener listener) {
   ...
   */
  public static void
  applySingleDebouncing(final View view, @IntRange(from = 0) long duration,
   ...
   */
  public static void
  applySingleDebouncing(final View[] views,
                        final View.OnClickListener listener) {
   ...
   */
  public static void
  applySingleDebouncing(final View[] views, @IntRange(from = 0) long duration,
                        final View.OnClickListener listener) {
   ...
   */
  public static void
  applyGlobalDebouncing(final View view, final View.OnClickListener listener) {
   ...
   */
  public static void
  applyGlobalDebouncing(final View view, @IntRange(from = 0) long duration,
                        final View.OnClickListener listener) {
   ...
   */
  public static void
  applyGlobalDebouncing(final View[] views,
                        final View.OnClickListener listener) {
   ...
   */
  public static void
  applyGlobalDebouncing(final View[] views, @IntRange(from = 0) long duration,
                        final View.OnClickListener listener) {
  ...
  public static void
  back2HomeFriendly(@NonNull final CharSequence tip, final long duration,
  ...
  public static abstract class OnDebouncingClickListener
    ...
    private static boolean isValid(@NonNull final View view,
                                   final long duration) {
    ...
    public OnDebouncingClickListener() { this(true, DEBOUNCING_DEFAULT_VALUE); }
  ...
  private static class OnUtilsTouchListener implements View.OnTouchListener {
    ...
    private void processAlpha(final View view, boolean isDown) {
      Object tag = view.getTag(isDown ? PRESSED_VIEW_ALPHA_TAG
                                      : PRESSED_VIEW_ALPHA_SRC_TAG);
      if (!(tag instanceof Float))
        return;
    ...
    private static class LazyHolder {
      private static final OnUtilsTouchListener INSTANCE =
    ...
    public void draw(Canvas canvas) {
      if (mBitmapDrawable == null) {
        Bitmap bitmap = Bitmap.createBitmap(
            getBounds().width(), getBounds().height(), Bitmap.Config.ARGB_8888);
