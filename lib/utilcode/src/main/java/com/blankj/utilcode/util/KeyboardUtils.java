...
public final class KeyboardUtils {
  ...
  public static void showSoftInput() {
    InputMethodManager imm =
        (InputMethodManager)Utils.getApp().getSystemService(
   ...
   *              0 or have the {@link InputMethodManager#SHOW_IMPLICIT} bit
   * set.
   */
  ...
  private static int getDecorViewInvisibleHeight(@NonNull final Window window) {
    ...
    if (delta <=
        UtilsBridge.getNavBarHeight() + UtilsBridge.getStatusBarHeight()) {
  ...
  public static void registerSoftInputChangedListener(
    ...
    final int[] decorViewInvisibleHeightPre = {
  ...
  public static void fixAndroidBug5497(@NonNull final Window window) {
    ...
    final int[] contentViewInvisibleHeightPre5497 = {
  ...
  private static int getContentViewInvisibleHeight(final Window window) {
    ...
    if (delta <=
        UtilsBridge.getStatusBarHeight() + UtilsBridge.getNavBarHeight()) {
      return 0;
    }
    return delta;
  }
  ...
  public static void fixSoftInputLeaks(@NonNull final Window window) {
    ...
    if (imm == null)
      return;
    String[] leakViews = new String[] {"mLastSrvView", "mCurRootView",
