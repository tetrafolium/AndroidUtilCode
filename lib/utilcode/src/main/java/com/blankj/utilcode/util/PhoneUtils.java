...
public final class PhoneUtils {
   ...
   * <p>If the version of SDK is greater than 28, it will return an empty
   * string.</p> <p>Must hold {@code <uses-permission
  ...
  public static String getSerial() {
    ...
    return Build.VERSION.SDK_INT >= Build.VERSION_CODES.O ? Build.getSerial()
                                                          : Build.SERIAL;
  }
  ...
  public static String getImeiOrMeid(boolean isImei) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      ...
      String ids =
          getSystemPropertyByReflect(isImei ? "ril.gsm.imei" : "ril.cdma.meid");
      ...
      try {
        ...
        id1 = (String)method.invoke(tm, isImei
  ...
  public static void sendSms(final String phoneNumber, final String content) {
    Utils.getApp().startActivity(
        UtilsBridge.getSendSmsIntent(phoneNumber, content));
  }

  private static TelephonyManager getTelephonyManager() {
    return (TelephonyManager)Utils.getApp().getSystemService(
