...
public void newUnmodifiableMap() {
	System.out.println(
		MapUtils.newUnmodifiableMap(Pair.create(0, "0"), Pair.create(1, "1"),
		                            Pair.create(2, "2"), Pair.create(3, "3")));
}

@Test
public void newHashMap() {
	System.out.println(
		MapUtils.newHashMap(Pair.create(0, "0"), Pair.create(1, "1"),
		                    Pair.create(2, "2"), Pair.create(3, "3")));
}
...
public void newLinkedHashMap() {
	System.out.println(
		MapUtils.newLinkedHashMap(Pair.create(0, "0"), Pair.create(1, "1"),
		                          Pair.create(2, "2"), Pair.create(3, "3")));
}
...
public void newTreeMap() {
	System.out.println(MapUtils.newTreeMap(
			...
			public int compare(Integer o1, Integer o2) {
				   ...
				   Pair.create(0, "0"), Pair.create(1, "1"), Pair.create(2, "2"),
				   Pair.create(3, "3")));
}
...
public void newHashTable() {
	System.out.println(
		MapUtils.newHashTable(Pair.create(0, "0"), Pair.create(1, "1"),
		                      Pair.create(2, "2"), Pair.create(3, "3")));
}
...
public void isEmpty() {
	...
	Assert.assertFalse(
		MapUtils.isEmpty(MapUtils.newHashMap(Pair.create(0, 0))));
}
...
public void isNotEmpty() {
	...
	Assert.assertTrue(
		MapUtils.isNotEmpty(MapUtils.newHashMap(Pair.create(0, 0))));
}
...
public void size() {
	...
	Assert.assertEquals(1,
	                    MapUtils.size(MapUtils.newHashMap(Pair.create(0, 0))));
}
