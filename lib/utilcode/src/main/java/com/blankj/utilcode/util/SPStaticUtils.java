...
public final class SPStaticUtils {
   ...
   * @return all values in sp
   */
  public static Map<String, ?> getAll() { return getAll(getDefaultSPUtils()); }
   ...
   */
  public static void clear() { clear(getDefaultSPUtils()); }
   ...
   * @param spUtils The instance of {@link SPUtils}.
   */
  public static void clear(@NonNull final SPUtils spUtils) { spUtils.clear(); }
