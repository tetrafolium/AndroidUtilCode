...
public final class SDCardUtils {
  ...
  public static List<SDCardInfo> getSDCardInfo() {
    ...
    StorageManager sm = (StorageManager)Utils.getApp().getSystemService(
    ...
    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
      ...
      try {
        ...
        for (int i = 0; i < length; i++) {
          ...
          boolean isRemovable =
              (Boolean)isRemovableMethod.invoke(storageVolumeElement);
  ...
  public static long getInternalTotalSize() {
    return UtilsBridge.getFsTotalSize(
  ...
  public static long getInternalAvailableSize() {
    return UtilsBridge.getFsAvailableSize(
        Environment.getDataDirectory().getAbsolutePath());
  }
  ...
  public static class SDCardInfo {
    ...
    public String toString() {
      return "SDCardInfo {"
          ...
          ", isRemovable = " + isRemovable + ", totalSize = " +
          Formatter.formatFileSize(Utils.getApp(), totalSize) +
          ", availableSize = " +
          Formatter.formatFileSize(Utils.getApp(), availableSize) + '}';
    }
  }
}
