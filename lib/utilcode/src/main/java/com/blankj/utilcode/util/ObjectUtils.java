...
public final class ObjectUtils {
  ...
  public static boolean isEmpty(final Object obj) {
    ...
    if ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) && (obj instanceof SparseLongArray &&
    ...
    if ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) && (obj instanceof android.util.LongSparseArray &&
   ...
   * @return {@code true}: yes<br>{@code false}: no
   */
  public static boolean isNotEmpty(final Object obj) { return !isEmpty(obj); }
  ...
  public static boolean isNotEmpty(final Map obj) { return !isEmpty(obj); }
