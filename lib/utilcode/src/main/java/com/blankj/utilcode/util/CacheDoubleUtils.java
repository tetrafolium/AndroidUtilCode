...
public final class CacheDoubleUtils implements CacheConstants {
   ...
   * @return the single {@link CacheDoubleUtils} instance
   */
  public static CacheDoubleUtils
  getInstance(@NonNull final CacheMemoryUtils cacheMemoryUtils,
              @NonNull final CacheDiskUtils cacheDiskUtils) {
    final String cacheKey =
        cacheDiskUtils.toString() + "_" + cacheMemoryUtils.toString();
  ...
  private CacheDoubleUtils(CacheMemoryUtils cacheMemoryUtils,
                           CacheDiskUtils cacheUtils) {
   ...
   * @return the size of cache in disk
   */
  public long getCacheDiskSize() { return mCacheDiskUtils.getCacheSize(); }
   ...
   * @return the count of cache in disk
   */
  public int getCacheDiskCount() { return mCacheDiskUtils.getCacheCount(); }
   ...
   * @return the count of cache in memory.
   */
  public int getCacheMemoryCount() { return mCacheMemoryUtils.getCacheCount(); }
