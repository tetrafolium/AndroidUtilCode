...
public class ThreadUtilsTest extends BaseTest {
  ...
  public void executeByFixedWithDelay() throws Exception {
    asyncTest(10, new TestRunnable<String>() {
      ...
      public void run(final int index, CountDownLatch latch) {
        ...
        ThreadUtils.executeByFixedWithDelay(3, task, 500 + index * 10,
  ...
  public void executeByFixedAtFixRate() throws Exception {
    asyncTest(10, new TestRunnable<String>() {
      @Override
      public void run(final int index, CountDownLatch latch) {
        final TestScheduledTask<String> task =
            new TestScheduledTask<String>(latch, 3) {
              @Override
              public String doInBackground() throws Throwable {
                Thread.sleep(500 + index * 10);
                if (index < 4) {
        ...
        ThreadUtils.executeByFixedAtFixRate(3, task, 3000 + index * 10,
                                            TimeUnit.MILLISECONDS);
      }
    });
  }
  ...
  public void executeBySingleWithDelay() throws Exception {
    asyncTest(10, new TestRunnable<String>() {
      ...
      public void run(final int index, CountDownLatch latch) {
        ...
        ThreadUtils.executeBySingleWithDelay(task, 500 + index * 10,
                                             TimeUnit.MILLISECONDS);
      }
    });
  }
  ...
  public void executeBySingleAtFixRate() throws Exception {
    asyncTest(10, new TestRunnable<String>() {
      ...
      public void run(final int index, CountDownLatch latch) {
        ...
        ThreadUtils.executeBySingleAtFixRate(task, 2000 + index * 10,
                                             TimeUnit.MILLISECONDS);
      }
    });
  }
  ...
  public void executeByIoWithDelay() throws Exception {
    asyncTest(10, new TestRunnable<String>() {
      ...
      public void run(final int index, CountDownLatch latch) {
        ...
        ThreadUtils.executeByIoWithDelay(task, 500 + index * 10,
                                         TimeUnit.MILLISECONDS);
      }
    });
  }
  ...
  public void executeByCpuWithDelay() throws Exception {
    asyncTest(10, new TestRunnable<String>() {
      ...
      public void run(final int index, CountDownLatch latch) {
        ...
        ThreadUtils.executeByCpuWithDelay(task, 500 + index * 10,
                                          TimeUnit.MILLISECONDS);
      }
    });
  }
  ...
  abstract static class TestTask<T> extends ThreadUtils.Task<T> {
    ...
    TestTask(final CountDownLatch latch) { mLatch = latch; }
  ...
  private <T> void asyncTest(int threadCount, TestRunnable<T> runnable)
      throws Exception {
