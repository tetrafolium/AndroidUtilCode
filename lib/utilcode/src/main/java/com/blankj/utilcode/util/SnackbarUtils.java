...
public final class SnackbarUtils {
  ...
  setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
   ...
   * Show the snackbar.
   */
  public Snackbar show() { return show(false); }
  ...
  public Snackbar show(boolean isShowTop) {
    ...
    if (isShowTop) {
      ...
      if (topSnackBarContainer == null) {
        CoordinatorLayout topSnackBarCoordinatorLayout =
            new CoordinatorLayout(view.getContext());
        ...
        suitableParent.addView(topSnackBarCoordinatorLayout,
    ...
    if (messageColor != COLOR_DEFAULT) {
      ...
      sReference =
          new WeakReference<>(Snackbar.make(view, spannableString, duration));
    } else {
      sReference = new WeakReference<>(Snackbar.make(view, message, duration));
    }
    final Snackbar snackbar = sReference.get();
    final Snackbar.SnackbarLayout snackbarView =
   ...
   */
  public void showSuccess() { showSuccess(false); }
   ...
   */
  public void showWarning() { showWarning(false); }
   ...
   */
  public void showError() { showError(false); }
