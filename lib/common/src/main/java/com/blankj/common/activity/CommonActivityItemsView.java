...
public class CommonActivityItemsView {
  ...
  public CommonActivityItemsView(@NonNull AppCompatActivity activity,
                                 @NonNull List<CommonItem> items) {
    mBaseActivity = activity;
    mItems = items;
  }

  public int bindLayout() { return R.layout.common_item; }
  ...
  public void initView() {
    ...
    mCommonItemRv.addItemDecoration(
        new RecycleViewDivider(mBaseActivity, RecycleViewDivider.VERTICAL,
